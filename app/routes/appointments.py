...
# Dans appointments.py, avant la route PUT /appointments/{appointment_id}
...
async def update_appointment(
    ...
    try:
        ...
        # Si le statut a été modifié, mettre à jour le statut du prospect associé
        if "status" in appointment_data and updated_appointment.get("prospect_id"):
            await update_prospect_status(
                db=db,
                prospect_id=updated_appointment["prospect_id"],
